...
<template>
  <div
    class="flex py-4 px-6 items-center bg-gray-100 border-b-2 border-slate-200 tracking-tight justify-between"
  >
    <span class="font-semibold text-lg text-pink-900">Create Vendor</span>
