...
<template>
  <div class="flex py-4 px-4 items-center bg-white border-b-2 border-slate-100 tracking-tight">
    ...
    <div class="ml-auto flex items-center">
      <span class="relative block bg-red-50 p-2 rounded-sm">
        ...
        <span
          class="absolute top-0 right-0 inline-flex items-center justify-center px-1 py-1 text-xs font-normal leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-xl">10</span>
      </span>

      <div class="flex ml-12 items-center">
        <img class="inline object-cover w-10 h-10 mr-2 rounded-full border-2 border-red-400"
          src="https://images.pexels.com/photos/2589653/pexels-photo-2589653.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
          alt="Profile image" />

        <div class="flex flex-col leading-tight">
          <span class="text-gray-800 text-sm font-semibold ">Benjamin Bello</span>
